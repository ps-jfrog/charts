...
export RECONCILE_BASE_DIR="/Users/sureshv/mycode/ps-jfrog/charts/ps/Testing_files_transfer/compare_source_to_target_and_fixrepodiff/test/test7_npm_folder-crawl"