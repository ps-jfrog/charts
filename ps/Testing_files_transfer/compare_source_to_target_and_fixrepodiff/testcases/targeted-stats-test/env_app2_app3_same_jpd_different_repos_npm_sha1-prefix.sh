...
export CLOUD_ARTIFACTORY_REPOS="sv-npmjs-remote-cache-copy1"

# Optional: where to put b4_upload/ and after_upload/ (default: script directory)
export RECONCILE_BASE_DIR="/Users/sureshv/mycode/ps-jfrog/charts/ps/Testing_files_transfer/compare_source_to_target_and_fixrepodiff/testcases/targeted-stats-test"
